...
new Vue({
    ...
    methods: {
        getVueItems: function (page) {
            this.$http.get('ctb_cat_monedasController?page=' + page).then((response) => {
        ...
        createItem: function () {
            ...
            this.$http.post('ctb_cat_monedasController', input).then((response) => {
        ...
        deleteItem: function (item) {
            this.$http.delete('ctb_cat_monedasController/' + item.cve_moneda).then((response) => {
                this.changePage(this.pagination.current_page);
        ...
        updateItem: function (cve_moneda) {
            ...
            this.$http.put('ctb_cat_monedasController/' + cve_moneda, input).then((response) => {
                this.changePage(this.pagination.current_page);
                this.newItem =  {'cve_moneda': '', 'nombre_moneda': '',  'simbolo': '','posicion': '','numero_decimales': ''};
