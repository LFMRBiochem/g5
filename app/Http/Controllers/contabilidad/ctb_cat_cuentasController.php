...
class ctb_cat_cuentasController extends Controller {
     ...
     public function get_centros_costo($cve_tipoCentroCosto) {
         $response = DB::table('ctb_cctipos_asociaciones')
                 ->join('ctb_cat_centros_costo', 'ctb_cat_centros_costo.id_centrocosto', '=',
'ctb_cctipos_asociaciones.id_centrocosto')
->where('ctb_cctipos_asociaciones.cve_tipoCentroCosto',
$cve_tipoCentroCosto)
                 ->where('ctb_cat_centros_costo.estatus', 'A')
->select('ctb_cat_centros_costo.id_centrocosto',
'ctb_cat_centros_costo.id_centrocosto AS id', 'ctb_cat_centros_costo.id_centrocosto_padre',
'ctb_cat_centros_costo.cve_centrocosto AS cuenta_contable', DB::raw(' 
replace(ctb_cat_centros_costo.nombre_centrocosto,"|"," ") as text'))
->orderBy('ctb_cat_centros_costo.id_centrocosto_padre', 'asc')
     ...
     public function get_conceptofinanciero_edit($id_cuenta,
$cve_tipoCentroCosto) {
         $response = DB::table('ctb_contabilidad_asociaciones')
                 ->distinct()
->select('ctb_contabilidad_asociaciones.id_conceptofinanciero')
                 ->join('ctb_cctipos_asociaciones',
'ctb_cctipos_asociaciones.id_centrocosto', '=',
'ctb_contabilidad_asociaciones.id_centrocosto')
...
$cve_tipoCentroCosto)
     ...
     public function editar_asociaciones(Request $request, $id_cuenta,
$centros_costo_change) {
...
$centros_costo_change)
         ...
         $plucked =
$id_contabilidad_asociacion->pluck('id_contabilidad_asociacion');
         ...
         foreach ($request->input('id_centrocosto') as
$fila_id_centrocosto) {
             foreach ($request->input('id_conceptofinanciero') as
$fila_id_conceptofinanciero) {
