...
<div class="modal fade" id="modalillo3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="container-fluid" id="modalillo_content3"></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" v-on:click="refreshTo"><i class="fa fa-power-off" aria-hidden="true"></i> Aceptar</button>
            </div>
        </div>
    </div>
</div>
